...
@Autonomous(name="Blue Right Auto Lower", group = "Centerstage Autonomous", preselectTeleOp = "RobotController")
public class BlueRightAuto_Lower extends LinearOpMode {
