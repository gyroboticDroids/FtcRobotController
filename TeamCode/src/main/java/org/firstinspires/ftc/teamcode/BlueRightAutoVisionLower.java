...
@Autonomous(name="Blue Right Auto Vision Lower", group = "Centerstage Autonomous", preselectTeleOp = "RobotController")
public class BlueRightAutoVisionLower extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        TrajectorySequence driveToCenterOfField = drive.trajectorySequenceBuilder(placePurplePixel.end())
                ...
                //Drive to board
                .splineToLinearHeading(new Pose2d(36,36.5 + boardOffset,0), Math.toRadians(90))
                .build();
        ...
        Trajectory driveToBoard = drive.trajectoryBuilder(driveToCenterOfField.end())
                .lineToLinearHeading(new Pose2d(49 - ye, 36.5 + boardOffset - ze, Math.toRadians(0 + pe)))
                .build();
