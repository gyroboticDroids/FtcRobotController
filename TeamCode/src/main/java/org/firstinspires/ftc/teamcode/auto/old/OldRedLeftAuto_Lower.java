...
@Autonomous(name="Old Red Left Auto Lower", group = "Centerstage Autonomous", preselectTeleOp = "RobotController")
@Disabled
public class OldRedLeftAuto_Lower extends LinearOpMode {
