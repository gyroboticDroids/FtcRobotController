...
@Autonomous(name="Red Left Auto Vision Lower With White", group = "Centerstage Autonomous Red", preselectTeleOp = "RobotController")
public class RedLeftAutoVisionLowerPickUpWhite extends LinearOpMode {
