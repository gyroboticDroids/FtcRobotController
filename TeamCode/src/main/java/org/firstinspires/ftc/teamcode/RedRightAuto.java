...
@Autonomous(name="Red Right Auto", group = "Centerstage Autonomous", preselectTeleOp = "RobotController")
public class RedRightAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        TrajectorySequence placePurplePixel = drive.trajectorySequenceBuilder(approachSpikeMarks.end())
                ...
                //Drives to board
                .splineToLinearHeading(new Pose2d(39,-34 + boardOffset,0),Math.toRadians(90))
                .build();
